...
| **Is scalable**<br>if deployed on autoscaled Kubernetes Cluster. You need to be Kubernetes proficient. Check you are skilled enough by watching [this video](https://www.youtube.com/watch?v=9wvEwPLcLcA). | **Is scalable**<br>Each connector is deployed independently of each other. You can have as many as you want. |
