...
>
> **Airbyte open-source platform is "batteries included"** 🔋. When you deploy it you'll get a server, workers, database, UI, orchestrator, connectors, secret manager, logs manager, etc. All of this is very well packaged and deployable on Kubernetes.
